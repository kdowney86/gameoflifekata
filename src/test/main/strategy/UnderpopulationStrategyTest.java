 ...
 */
public class UnderpopulationStrategyTest {
    private final String DEAD_STR = GameOfLifeConstants.DEAD_STR;
    private final String ALIVE_STR = GameOfLifeConstants.ALIVE_STR;

    private UnderpopulationStrategy underpopulationStrategy = new UnderpopulationStrategy();
    ...
    @Test
    public void testAnyLiveCellWithFewerThanTwoLiveNeighboursDiesNoNeighbours() {
        //given
    ...
    @Test
    public void testAnyLiveCellWithFewerThanTwoLiveNeighboursDiesOneNeighbour() {
        //given
        gameBoardBuilder = gameBoardBuilder.withRow(new ArrayList<>(Arrays.asList(DEAD_STR, DEAD_STR, DEAD_STR, DEAD_STR)));
        gameBoardBuilder = gameBoardBuilder.withRow(new ArrayList<>(Arrays.asList(DEAD_STR, DEAD_STR, DEAD_STR, DEAD_STR)));
    ...
    @Test
    public void testAnyLiveWithTwoNeighboursIsNotProcessed() {
        //given
